"use strict";var e;Object.defineProperty(exports,"__esModule",{value:!0}),!function(e,t){for(var i in t)Object.defineProperty(e,i,{enumerable:!0,get:t[i]})}(exports,{Chrome:function(){return s},ChromeBasic:function(){return l},getProfileByEmail:function(){return r}});const t=require("selenium-webdriver"),i=(e=require("selenium-webdriver/chrome.js"))&&e.__esModule?e:{default:e},n=require("jnu-abc");function a(e,t,i){return t in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}const r=(e="",t="")=>{if(!t)return null;for(let i of(0,n.findFolders)(t,"Profile")){let t=(0,n.loadJson)(`${i}/Preferences`);if(t.account_info&&t.account_info.length>0&&t.account_info[0].email===e)return i.replace(/\\/g,"/").split("/").pop()||null}return null};class s{async getFullSize(){let e=0,t=0;for(;;){let{viewportHeight:i,documentHeight:n,scrollY:a}=await this.driver.executeScript(`
        return {
